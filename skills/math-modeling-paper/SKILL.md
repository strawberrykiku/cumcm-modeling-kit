...
根据比赛类型加载详细指南：
- 国赛 → 读取 `references/cumcm-guide.md`，**并读取 `references/cumcm-format-spec.md`（官方硬性格式要求，优先级最高）**
...
- `references/cumcm-format-spec.md` — **国赛官方硬性格式要求速查（优先级最高）**：页面页码篇幅、匿名红线、标准章节结构、字体字号表、图表公式参考文献规范、AI 声明、提交前检查
